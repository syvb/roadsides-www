    ...
    routeTable: [
      ...
      function(pageName, fail) {
        ...
        dbRequest.addEventListener("load", function(dbData) {
          ...
          document.querySelectorAll("meta[property], meta[name='twitter:title'], meta[name='twitter:image:alt'], meta[name='twitter:image:src'], meta[name='twitter:description'], meta[name='twitter:card'], meta[name='twitter:site'], meta[name='twitter:creator'], meta[name='twitter:domain'], meta[name='twitter:url']").forEach(x => x.remove())
